    ...
    <div class="container  py-2">
        <div class="row d-flex py-3 justify-content-center align-items-center position-relative">
            <div style="height: 10rem; overflow: hidden; width: 100%;" class="position-relative">
                <img class="img-fluid w-100 h-100 object-fit-cover" src="{{ asset('images/lit.avif') }}" alt="">
                <!-- Texte superposé sur l'image -->
                <h1 class="position-absolute top-50 start-50 translate-middle text-center text-white font-bold">LITS</h1>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="row d-flex flex-wrap">
                        <div class="col-6 col-md-2 mb-3 ">
                            <img class="img-fluid rounded" src="{{ asset('images/lit.avif') }}" alt="Canapé 1">
                            <div class=" row mt-3">
